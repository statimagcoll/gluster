...
marker=3
invisible(sapply(names(constrCfGMMbunch), function(x) plot(constrCfGMMbunch[[x]], marker = marker, boundary = quantile(constrGMMfit$expressionX[,marker], probs=quantileBoundaries[[marker]][2,1]), title = x ) ))
